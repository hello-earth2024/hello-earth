...
const RedirectToHTML_4 = () => {
  ...
  const closePopup = () => {
    ...
    window.location.href = "/cesium/examples/cesium/time_4.html"; // Modify this URL as needed
  };
      ...
      {showPopup && (
        <div style={popupStyle}>
          <div style={isMobile ? popupContentStyleMobile : popupContentStyle}>
            ...
            These images, which show the vegetation index for regions around the world, are generated from MODIS (Moderate Resolution Imaging Spectroradiometer), a key instrument on NASA's Terra satellite, which is the first satellite of NASA's Earth Observing System (EOS) program.
            </p> 
            <p style={{ color: "black", fontSize: isMobile ? "14px" : "18px", marginBottom: "20px" }}>
...
export default RedirectToHTML_4;
