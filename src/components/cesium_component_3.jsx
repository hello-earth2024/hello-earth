...
const RedirectToHTML_3 = () => {
  ...
  const closePopup = () => {
    ...
    window.location.href = "/cesium/examples/cesium/time_3.html"; // Modify this URL as needed
  };
      ...
      {showPopup && (
        <div style={popupStyle}>
          <div style={isMobile ? popupContentStyleMobile : popupContentStyle}>
            ...
            This visualization shows the concentration of carbon monoxide in parts per billion at an altitude of approximately 5,500 meters (18,000 feet) above sea level. The data used is provided by the Atmospheric Infrared Sounder (AIRS), one of the six instruments aboard NASA's Aqua satellite.
            </p> 
            <p style={{ color: "black", fontSize: isMobile ? "14px" : "18px", marginBottom: "20px" }}>
...
export default RedirectToHTML_3;
