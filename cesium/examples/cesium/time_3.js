...
// MAPA FEIO, SE DER TEMPO, ALTERAR
...
window.onload = function () {
  ...
  var button2 = createButton('button2', 'Flying Rivers');
  ...
  var createDailyProvider = function () {
    ...
    return new Cesium.WebMapTileServiceImageryProvider({
      ...
      layer: 'AIRS_L3_Carbon_Monoxide_500hPa_Volume_Mixing_Ratio_Monthly_Day',
      style: '',
      format: 'image/png',
      tileMatrixSetID: '2km',
      maximumLevel: 8,
  ...
  function doClockUpdate() {
    ...
    var imageryLayer = viewer.scene.imageryLayers.addImageryProvider(createDailyProvider());
    imageryLayer.alpha = 0.5; // Set opacity here (0.5 means 50% opacity)
}
