...
window.onload = function () {
  ...
  var button3 = createButton('button3', 'Carbon Monoxide');
  var button4 = createButton('button4', 'Vegetation');
  ...
  function doClockUpdate() {
    ...
    imageryLayer.alpha = 0.8; // Set opacity here (0.5 means 50% opacity)
}
